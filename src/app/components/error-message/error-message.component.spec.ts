...
describe('ErrorMessageComponent', () => {
  ...
  it('it should hide error message on field not touched',()=>{
    component.field=new FormGroup({anyField:new FormControl()})
    component.field.setErrors({anyError:true});
    component.error="anyError"
    expect(component.shouldShowComponent()).toBeFalsy();
  })
  it('it should hide error message on field touched ,but not messages',()=>{
    component.field=new FormGroup({anyField:new FormControl()})
    component.field.markAsTouched();
    component.error="anyError"
    expect(component.shouldShowComponent()).toBeFalsy();
  })
  it('it should hide error message on field not touched and has error,but it is different error',()=>{
    component.field=new FormGroup({anyField:new FormControl()})
    component.field.markAsTouched();
    component.field.setErrors({anyError:true});
